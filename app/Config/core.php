...
if (env('DEBUG_LEVEL')>0) {
  Configure::write('debug', env('DEBUG_LEVEL'));
} else {
 ...
 */
	Configure::write('Security.salt', 'guVoUfIxfs2WwvniR2G0FubDYhG93b0qyJgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76354249856749594683643096575');
